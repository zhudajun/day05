...
- (void)customBigCircleAndSmallCircleWithWidth:(CGFloat)width Height:(CGFloat)height {
   ...
   UIBezierPath *ovalPath = [UIBezierPath bezierPathWithOvalInRect:bigOvalRect];
    ...
    smallOvalLayer.strokeColor = kIndicatorColor.CGColor;
    smallOvalLayer.fillColor = kIndicatorColor.CGColor;
    ...
    triangleLayer.strokeColor = kIndicatorColor.CGColor;
    triangleLayer.fillColor = kIndicatorColor.CGColor;
